...
def main(argv):
    ...
    try:
        opts, args = getopt.getopt(argv, "f:e:d:b:t:p:r:g:m:u:",
                                   ["training_file=", "test_file=", "depth=", "branching_limit=", "time_limit=",
                                    "pred=", "robust=", "data_group=", "ml=", "treatment_options="])
    ...
    if robust == 'robust':
        data_path_dict = {'Warfarin_seed1': ('/../data/Warfarin_v2/seed1/', '/../Results_Robust/Warfarin_v2/seed1/'),
                      ...
                      'Warfarin_seed5': ('/../data/Warfarin_v2/seed5/', '/../Results_Robust/Warfarin_v2/seed5/'),
                          'Athey_v1_500': ('/../data/Athey_v1/500/', '/../Results_Robust/Athey_v1/'),
                          'Athey_v2_4000': ('/../data/Athey_v2/4000/', '/../Results_Robust/Athey_v2/')}
    elif robust == 'direct':
        data_path_dict = {'Warfarin_seed1': ('/../data/Warfarin_v2/seed1/', '/../Results_Direct/Warfarin_v2/seed1/'),
                      ...
                      'Warfarin_seed5': ('/../data/Warfarin_v2/seed5/', '/../Results_Direct/Warfarin_v2/seed5/'),
                          'Athey_v1_500': ('/../data/Athey_v1/500/', '/../Results_Direct/Athey_v1/'),
                          'Athey_v2_4000': ('/../data/Athey_v2/4000/', '/../Results_Direct/Athey_v2/')}
    else:
        data_path_dict = {'Warfarin_seed1': ('/../data/Warfarin_v2/seed1/', '/../Results/Warfarin_v2/seed1/'),
                      ...
                      'Warfarin_seed5': ('/../data/Warfarin_v2/seed5/', '/../Results/Warfarin_v2/seed5/'),
                          'Athey_v1_500': ('/../data/Athey_v1/500/', '/../Results/Athey_v1/'),
                          'Athey_v2_4000': ('/../data/Athey_v2/4000/', '/../Results/Athey_v2/')}
    ...
    primal = Primal(agg, features, dr_outcome, regression, robust, tree, branching_limit, time_limit)
