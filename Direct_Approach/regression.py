...
for dataset in datasets:
    ...
    df = pd.read_csv('../data/Warfarin_2000/' + file_name)
    df_enc = pd.read_csv('../data/Warfarin_2000/' + file_name_enc)
    ...
    #f_enc.to_csv('../data/Warfarin_2000/' + file_name_enc, index=False)
