...
def main():
    ...
    slurm_file = 'slurm_IPW_' + 'Athey_v1.sh'
    depths = [1]
    ...
    # slurm_file = 'slurm_IPW_' + 'Warfarinv2_r.sh'
    # depths = [1, 2, 3, 4]
    ...
    # data_groups = ['Warfarin_seed1','Warfarin_seed2','Warfarin_seed3','Warfarin_seed4','Warfarin_seed5'] #Warfarin_3000 Athey_v1_500  Athey_v2_4000
    # # data_groups = ['Warfarin_seed1'] 
    # slurm_file = 'slurm_IPW_' + 'Warfarinv2_0.33.sh'
    # depths = [1, 2, 3, 4]
    # thresholds = ["0.33"]
    # preds = ['tree']
    # mls = ['ml']
    ...
    # data_groups = ['Warfarin_seed1','Warfarin_seed2','Warfarin_seed3','Warfarin_seed4','Warfarin_seed5'] #Warfarin_3000 Athey_v1_500  Athey_v2_4000
    # data_groups = ['Warfarin_seed1'] 
    # slurm_file = 'slurm_IPW_' + 'Warfarinv2_test.sh'
    # depths = [1]
    # thresholds = ["r0.06", "r0.11"]
    # preds = ['tree']
    # mls = ['lrrf']
