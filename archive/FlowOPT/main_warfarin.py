...
def main(argv):
    ...
    try:
        opts, args = getopt.getopt(argv, "f:e:d:b:t:p:g:u:c:",
                                   ["training_file=", "test_file=", "depth=", "branching_limit=", "time_limit=",
                                    "pred=", "data_group=", "fairness_bound=", "protected_col="])
    ...
    data_path_dict = {'Warfarin_seed1': ('/../data/Warfarin_v2/seed1/', '/../Results/Warfarin_v2/fairness/seed1/'),
                      'Warfarin_seed2': ('/../data/Warfarin_v2/seed2/', '/../Results/Warfarin_v2/fairness/seed2/'),
                      'Warfarin_seed3': ('/../data/Warfarin_v2/seed3/', '/../Results/Warfarin_v2/fairness/seed3/'),
                      'Warfarin_seed4': ('/../data/Warfarin_v2/seed4/', '/../Results/Warfarin_v2/fairness/seed4/'),
                      'Warfarin_seed5': ('/../data/Warfarin_v2/seed5/', '/../Results/Warfarin_v2/fairness/seed5/'),
    ...
    out_put_name = data_group + '_' + training_file.split('.csv')[0] + '_' + approach_name + '_d_' + str(
        ...
        branching_limit) + '_pred_' + prob_type_pred + f'_{protected_col}_' + str(fairness_bound)
    ...
    primal = Primal(data_train, features, protected_col, treatment_col, true_outcome_cols, outcome, prob_t, tree,
                           branching_limit, fairness_bound,
                           time_limit)
