...
train_data_list="data_train_enc_r0.06_1.csv data_train_enc_r0.06_2.csv
"
test_data_list="data_test_enc_r0.06_1.csv data_test_enc_r0.06_2.csv
"
depth_list="1 1
"
...
"
fairness_bounds_list="0.06 0.06
"
...
python main_warfarin.py -f ${train_data_list[$SLURM_ARRAY_TASK_ID]} -e ${test_data_list[$SLURM_ARRAY_TASK_ID]} -d ${depth_list[$SLURM_ARRAY_TASK_ID]} -t 10800 -b 100 -p ${pred_type_list[$SLURM_ARRAY_TASK_ID]} -g ${data_group_list[$SLURM_ARRAY_TASK_ID]} -u ${fairness_bounds_list[$SLURM_ARRAY_TASK_ID]} -c ${protected_cols_list[$SLURM_ARRAY_TASK_ID]}
